...
describe("lab result clinical safety contract", () => {
  ...
  it("registers correction and replacement ledgers in backup and RLS maintenance", () => {
    ...
    expect(rls).toContain(
      "clinical_record_corrections, demo_accesses, dispense_charge_events, dispense_charge_queue, file_object_replicas, file_storage_events, funnel_events, lab_result_events, lab_result_replacements",
    );
