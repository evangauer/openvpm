...
/**
 * Durable, cross-tenant evidence for one scheduled database-backup sweep.
 *
 * This table deliberately contains aggregate counts only: no clinic identity,
 * patient data, object key, provider credential, or provider error text. RLS
 * and migration-level grants restrict it to explicit system context.
 */
